 ...
 * @author bruno
 */
public class FormaPlanaTriangulo extends javax.swing.JInternalFrame {

    /**
     * Creates new form FormaPlanaTriangulo
     */
    public FormaPlanaTriangulo() {
        initComponents();
    }

    private void calcular(){
        Float resultado = Float.parseFloat(txtBase.getText()) * Float.parseFloat(txtAltura.getText())/2;
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnLimpar, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 230, -1, -1));
        ...
        jPanel4.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(90, 240, 50, 30));

        jLabel5.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel5.setText("A= b x h");
        jPanel4.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 50, 20));

        jSeparator2.setBackground(new java.awt.Color(0, 0, 0));
        jSeparator2.setForeground(new java.awt.Color(0, 0, 0));
        jPanel4.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 50, 10));

        jLabel6.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel6.setText("2");
        jPanel4.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(1, 20, 50, -1));
        ...
        getContentPane().add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 190, -1, 30));
